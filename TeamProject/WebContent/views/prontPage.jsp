...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/templet/css/bootstrap.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/templet/css/animate.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/templet/css/owl.carousel.min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/templet/css/aos.css">

<link rel="stylesheet"
	href="${pageContext.request.contextPath}/templet/fonts/ionicons/css/ionicons.min.css">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/templet/fonts/fontawesome/css/font-awesome.min.css">

<!-- Theme Style -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/templet/css/style.css">
<style>
body {
...
<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-4 site-logo" data-aos="fade">
					<a href="index.jsp"><em>Team404</em></a>
				</div>
				<div class="col-8">
								...
								<div class="row full-height align-items-center">
									<div class="col-md-6">
										<ul class="list-unstyled menu">
											...
											<li><a href="board.do">포토 게시판</a></li>
										</ul>
									</div>
									<div class="col-md-6 extra-info">
										<div class="row">
											<div class="col-md-6 mb-5">
												<h3>오시는길</h3>
												<p>
													대구광역시 중구 국채보상로 537 (수동, 5층) <br> 살려주세요ㅠㅠ
												</p>
	...
	<section class="site-hero overlay"
		style="background-image: url(${pageContext.request.contextPath}/templet/img/hero_1.jpg)">
		<div class="container">
			<div
	...
	<div class="row bordertop pt-5">
		<p class="col-md-6 text-left">
			...
			made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a
				href="https://colorlib.com" target="_blank">Team404</a>
			<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
		</p>
	...
	<script
		src="${pageContext.request.contextPath}/templet/js/popper.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/templet/js/bootstrap.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/templet/js/owl.carousel.min.js"></script>
