...
<html>
  <head>
    ...
    <link rel="stylesheet" href="bootstrep/fonts/icomoon/style.css">

    <link rel="stylesheet" href="bootstrep/css/bootstrap.min.css">
    <link rel="stylesheet" href="bootstrep/css/jquery-ui.css">
    <link rel="stylesheet" href="bootstrep/css/owl.carousel.min.css">
    <link rel="stylesheet" href="bootstrep/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="bootstrep/css/owl.theme.default.min.css">

    <link rel="stylesheet" href="bootstrep/css/jquery.fancybox.min.css">

    <link rel="stylesheet" href="bootstrep/css/bootstrap-datepicker.css">

    <link rel="stylesheet" href="bootstrep/fonts/flaticon/font/flaticon.css">

    <link rel="stylesheet" href="bootstrep/css/aos.css">

    <link rel="stylesheet" href="bootstrep/css/style.css">
  ...
  <script src="bootstrep/js/jquery-3.3.1.min.js"></script>
  <script src="bootstrep/js/jquery-ui.js"></script>
  <script src="bootstrep/js/popper.min.js"></script>
  <script src="bootstrep/js/bootstrap.min.js"></script>
  <script src="bootstrep/js/owl.carousel.min.js"></script>
  <script src="bootstrep/js/jquery.countdown.min.js"></script>
  <script src="bootstrep/js/jquery.easing.1.3.js"></script>
  <script src="bootstrep/js/aos.js"></script>
  <script src="bootstrep/js/jquery.fancybox.min.js"></script>
  <script src="bootstrep/js/jquery.sticky.js"></script>
  <script src="bootstrep/js/isotope.pkgd.min.js"></script>

  
  <script src="bootstrep/js/main.js"></script>
