                            ...
                            <div class="col-lg-7 col-md-9 ">
                                <div class="hero__caption text-center d-flex align-items-center caption-bg">
                                   <div class="circle-caption">
                                        <span  data-animation="fadeInUp" data-delay=".3s">어서오세요</span>
                                        <h1  data-animation="fadeInUp" data-delay=".5s">환영합니다.</h1>
                                        <p  data-animation="fadeInUp" data-delay=".9s">We Will Have GreatParty!</p>
                                   </div>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="single-footer-caption mb-50">
                         <div class="single-footer-caption mb-30">
                             ...
                             <div class="footer-logo">
                                 <a href="${pageContext.request.contextPath}/home.do"><img src="assets/img/logo/logo2_footer.png" alt=""></a>
                             </div>
