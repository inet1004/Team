<%@page import="Upload.DefaultFileRenamePolicy"%>
<%@page import="Upload.MultipartRequest"%>
...
<%
	...
	try {
		MultipartRequest multi = new MultipartRequest( // MultipartRequest 인스턴스 생성(cos.jar넣어야됨)
				request, 
